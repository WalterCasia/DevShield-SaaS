...
[![Gemini](https://img.shields.io/badge/Google_Gemini-1.5_Flash-4285F4?style=for-the-badge&logo=googlegemini&logoColor=white)](https://ai.google.dev/)
...
graph TD
    subgraph FASE_1["🔵 FASE 1 · Indexación (una vez por sesión)"]
        ...
        D --> E[("🗄️ Índice FAISS<br/>en memoria")]
    end
    ...
    subgraph FASE_2["🟢 FASE 2 · Consulta (por cada pregunta)"]
        ...
        I --> J["🤖 Gemini 1.5 Flash<br/>temperatura 0.2"]
...
| **Gemini 1.5 Flash** | GPT-4, Claude, Llama local | Capa gratuita generosa, latencia muy baja y ventana de contexto amplia: ideal para un asistente de documentación. |
...
devshield-rag-agent/
│
├── app.py                      # 🖥️  Interfaz Streamlit (chat, sidebar, estado)
...
│
├── scripts/
│   └── generar_pdf.py          # 🛠️  Regenera el PDF desde el Markdown
│
└── .streamlit/
...
| # | ❓ Pregunta del usuario | 🛡️ Respuesta esperada del agente | 📄 Fuente |
|:--:|---|---|:--:|
...
> ⏱️ Esta es la parte más lenta (~2–4 min la primera vez): `sentence-transformers`
...
> ⚠️ **DevShield SaaS es una empresa ficticia.** Todo el contenido del documento
...
**¿Te resultó útil?** Deja una ⭐ en el repositorio.
